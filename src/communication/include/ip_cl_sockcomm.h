/*
 * File:  ip_cl_sockcomm.h                       Version: 001
...
#ifndef __NPS_IP_CL_SOCKCOMM__
#define __NPS_IP_CL_SOCKCOMM__

#include "ip_sockcomm.h"
#include "cl_sockcomm.h"


class IP_CL_SockCommClass : public IP_SockCommClass, public CL_SockCommClass {

public:
   IP_CL_SockCommClass ( const unsigned short /*network port*/,
                         const char *         /*network interface*/,
                         const int            /*network loopback flag*/,
                         const short          /*network comm_flags*/ );
   virtual ~IP_CL_SockCommClass ();
