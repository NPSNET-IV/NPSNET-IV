/*
 * File:  up_cl_sockcomm.h                       Version: 001
...
#ifndef __NPS_UP_CL_SOCKCOMM__
#define __NPS_UP_CL_SOCKCOMM__

#include "up_sockcomm.h"
#include "cl_sockcomm.h"


class UP_CL_SockCommClass : public UP_SockCommClass, public CL_SockCommClass {

public:

   UP_CL_SockCommClass ( const char * /*local_path*/,
                         const char * /*remote_path*/ );
   virtual ~UP_CL_SockCommClass ();
...
private:
   ...
   char partner_path[UP_PATH_SIZE+1];  // The desire partner
   char my_path[UP_PATH_SIZE+1];       // The name for us

};

#endif

// End file - up_cl_sockcomm.h
