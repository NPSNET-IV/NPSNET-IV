/*
 * File:  uc_ip_cl_sockcomm.h                    Version: 001
...
#ifndef __NPS_UC_IP_CL_SOCKCOMM__
#define __NPS_UC_IP_CL_SOCKCOMM__

#include "ip_cl_sockcomm.h"

#define DEFAULT_UC_PORT 3050


class UC_IP_CL_SockCommClass : public IP_CL_SockCommClass {

public:

   UC_IP_CL_SockCommClass ( const unsigned short /*network port*/,
                            const char *         /*network interface*/,
                            const char *         /*partner ip address*/,
                            const int            /*network loopback*/ );
   virtual ~UC_IP_CL_SockCommClass ();
...
private:
   ...
   char partner_ip[NETADDRSIZE];

};

#endif

// End file - uc_ip_cl_sockcomm.h
