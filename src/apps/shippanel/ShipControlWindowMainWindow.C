...
//////////////////////////////////////////////////////////////
//
// Source file for ShipControlWindowMainWindow
//
...
String  ShipControlWindowMainWindow::_defaultShipControlWindowMainWindowResources[] = {
        (char*)NULL
};
...
ShipControlWindowMainWindow::~ShipControlWindowMainWindow()
{
    delete _deck;
} // End destructor


const char *ShipControlWindowMainWindow::className()
{
    return ("ShipControlWindowMainWindow");
} // End className()


Boolean ShipControlWindowMainWindow::okToQuit()
{
...
void ShipControlWindowMainWindow::functionloop()
{
  IDUType type;
  char *idu;
  TestIDU *testidu;
  ...
  int number_read = 0;
           ...
           (net->read_idu(&idu, &type, idu_sender_info, swap_bufs) != NULL)  )
       {
        switch(type)
           ...
           case (NPSNET_To_SHIP_Type):
             updateshipidu = (NPSNETToShipIDU *)idu;
             break;
           default:
   ...
   // Process the Voice Command text field
   //_deck->process_voice_cmd();
