...
#ifndef __NPS_TERRAIN_H__
#define __NPS_TERRAIN_H__

#include <pf.h>

//obj placement
pfGroup *findnode(pfVec3 );  
pfGroup *deviy_up(void);
pfGroup *build_objtree(int, int, int, int, int);

//terrain placement
void deviy_up_dirt();
pfGroup *build_dirttree(int, int, int, int, int);
pfGroup *findnode_dirt(pfVec3);

//void readnplacemodels(char *);
...
int person_orient(pfCoord &);

void person_altitude (float &, pfCoord &);
